...
{
    String threadName;                                                                                                                                                                                          //int flagDeliver
    public customer thisCustomer=new customer();;

    public deliveredThread(int flagDelivered)
    {
        this.threadName="DELIVERY THREAD";                                                                              //delivery status notification thread //this.thisCustomer=thisCustomer;//checkStatus(thisCustomer,flagDelivered);
    }

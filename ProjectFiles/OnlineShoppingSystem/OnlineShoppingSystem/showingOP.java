...
class signUp extends customer implements ActionListener 
{
    ...
    signUp(String customerName,long customerID,long customerPhoneNo,long customerCredits,String customerAddress,String customerEmail,int customerSize,char customerGender,String customerPassword, String prevOrders,long customerTotalBill)
    {
        super(customerName,customerID,customerPhoneNo,customerCredits,customerAddress,customerEmail,customerSize,customerGender,customerPassword,prevOrders,customerTotalBill);
    }
    @Override
    public void actionPerformed(ActionEvent a)
    {
